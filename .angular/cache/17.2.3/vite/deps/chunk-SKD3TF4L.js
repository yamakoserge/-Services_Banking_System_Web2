...
_NzSubMenuTitleComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 5,
  vars: 3,
  consts: [["nz-icon", ""], [4, "nzStringTemplateOutlet"], [1, "ant-dropdown-menu-submenu-expand-icon"], ["nz-icon", "", 3, "nzType"], [1, "ant-menu-title-content"], ["nz-icon", "", "nzType", "left", 1, "ant-dropdown-menu-submenu-arrow-icon"], ["nz-icon", "", "nzType", "right", 1, "ant-dropdown-menu-submenu-arrow-icon"], [1, "ant-menu-submenu-arrow"]],
...
//# sourceMappingURL=chunk-SKD3TF4L.js.map
