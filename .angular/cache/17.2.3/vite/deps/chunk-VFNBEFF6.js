...
_NzAvatarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 3,
  consts: [["textEl", ""], ["nz-icon", ""], [1, "ant-avatar-string"], ["nz-icon", "", 3, "nzType"], [3, "error", "src"]],
  template: function NzAvatarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, NzAvatarComponent_Conditional_0_Template, 1, 1, "span", 1)(1, NzAvatarComponent_Conditional_1_Template, 1, 3, "img")(2, NzAvatarComponent_Conditional_2_Template, 3, 1, "span", 2);
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-VFNBEFF6.js.map
