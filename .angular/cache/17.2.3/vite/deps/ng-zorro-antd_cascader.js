import {
  NzHighlightModule,
  NzHighlightPipe
} from "./chunk-Q477WZBE.js";
import {
  NzEmbedEmptyComponent,
  NzEmptyModule
} from "./chunk-W6XCHNW5.js";
import {
  NzI18nService
...
function NzCascaderOptionComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzCascaderOptionComponent_Conditional_0_ng_template_0_Template, 0, 0, "ng-template", 1);
  }
  if (rf & 2) {
...
function NzCascaderComponent_Conditional_3_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzCascaderComponent_Conditional_3_Conditional_7_Conditional_1_Template, 1, 3, "span", 15)(2, NzCascaderComponent_Conditional_3_Conditional_7_Conditional_2_Template, 1, 0)(3, NzCascaderComponent_Conditional_3_Conditional_7_Conditional_3_Template, 1, 1, "nz-form-item-feedback-icon");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
...
function NzCascaderComponent_ng_template_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "ul", 22)(1, "li", 23);
    ɵɵelement(2, "nz-embed-empty", 24);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
...
function NzCascaderComponent_ng_template_5_Conditional_4_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(1, NzCascaderComponent_ng_template_5_Conditional_4_For_1_For_2_Template, 1, 8, "li", 27, _forTrack0);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NzCascaderComponent_ng_template_5_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵrepeaterCreate(0, NzCascaderComponent_ng_template_5_Conditional_4_For_1_Template, 3, 5, "ul", 25, ɵɵrepeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
...
_NzCascaderOptionComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 2,
  consts: [[1, "ant-cascader-menu-item-expand-icon"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "ant-cascader-menu-item-content", 3, "innerHTML"], ["nz-icon", "", "nzType", "loading"], [4, "nzStringTemplateOutlet"], ["nz-icon", "", 3, "nzType"]],
  template: function NzCascaderOptionComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, NzCascaderOptionComponent_Conditional_0_Template, 1, 5)(1, NzCascaderOptionComponent_Conditional_1_Template, 2, 6)(2, NzCascaderOptionComponent_Conditional_2_Template, 3, 1, "div", 0);
    }
    if (rf & 2) {
