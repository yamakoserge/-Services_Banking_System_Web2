...
function NzCarouselComponent_Conditional_6_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzCarouselComponent_Conditional_6_For_2_ng_template_1_Template, 0, 0, "ng-template", 8);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function NzCarouselComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(1, NzCarouselComponent_Conditional_6_For_2_Template, 2, 6, "li", null, ɵɵrepeaterTrackByIdentity);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
_NzCarouselComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 9,
  vars: 3,
  consts: [["slickList", ""], ["slickTrack", ""], ["renderDotTemplate", ""], [1, "slick-initialized", "slick-slider"], ["tabindex", "-1", 1, "slick-list", 3, "mousedown", "touchstart"], [1, "slick-track"], [1, "slick-dots"], [3, "click"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"]],
