...
function NzInputNumberGroupComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzInputNumberGroupComponent_Conditional_1_Conditional_0_Template, 1, 1)(1, NzInputNumberGroupComponent_Conditional_1_Conditional_1_Template, 1, 1);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
function NzInputNumberGroupComponent_ng_template_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzInputNumberGroupComponent_ng_template_2_Conditional_2_Conditional_1_Template, 1, 1, "nz-form-item-feedback-icon");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function NzInputNumberGroupComponent_ng_template_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NzInputNumberGroupComponent_ng_template_4_Conditional_1_Conditional_1_Template, 1, 1, "nz-form-item-feedback-icon");
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function NzInputNumberGroupComponent_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵprojection(0);
    ɵɵtemplate(1, NzInputNumberGroupComponent_ng_template_4_Conditional_1_Template, 2, 1, "span", 9);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
...
_NzInputNumberGroupSlotComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 2,
  consts: [["nz-icon", ""], [4, "nzStringTemplateOutlet"], ["nz-icon", "", 3, "nzType"]],
...
_NzInputNumberGroupComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 6,
  vars: 1,
  consts: [["affixTemplate", ""], ["contentTemplate", ""], [1, "ant-input-number-wrapper", "ant-input-number-group"], ["nz-input-number-group-slot", "", "type", "addon"], [1, "ant-input-number-affix-wrapper"], ["nz-input-number-group-slot", "", "type", "addon", 3, "icon", "template"], [1, "ant-input-number-affix-wrapper", 3, "ngClass"], [3, "ngTemplateOutlet"], ["nz-input-number-group-slot", "", "type", "prefix"], ["nz-input-number-group-slot", "", "type", "suffix"], ["nz-input-number-group-slot", "", "type", "prefix", 3, "icon", "template"], ["nz-input-number-group-slot", "", "type", "suffix", 3, "icon", "template"], [3, "status"]],
