...
_NzSiderTriggerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 6,
  vars: 2,
  consts: [["defaultTrigger", ""], ["defaultZeroTrigger", ""], [3, "ngTemplateOutlet"], ["nz-icon", ""], ["nz-icon", "", 3, "nzType"], ["nz-icon", "", "nzType", "bars"]],
  template: function NzSiderTriggerComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, NzSiderTriggerComponent_Conditional_0_Template, 1, 1)(1, NzSiderTriggerComponent_Conditional_1_Template, 1, 1)(2, NzSiderTriggerComponent_ng_template_2_Template, 2, 1, "ng-template", null, 0, ɵɵtemplateRefExtractor)(4, NzSiderTriggerComponent_ng_template_4_Template, 1, 0, "ng-template", null, 1, ɵɵtemplateRefExtractor);
    }
    if (rf & 2) {
...
_NzSiderComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 3,
  vars: 1,
  consts: [[1, "ant-layout-sider-children"], ["nz-sider-trigger", ""], ["nz-sider-trigger", "", 3, "click", "matchBreakPoint", "nzCollapsedWidth", "nzCollapsed", "nzBreakpoint", "nzReverseArrow", "nzTrigger", "nzZeroTrigger", "siderWidth"]],
